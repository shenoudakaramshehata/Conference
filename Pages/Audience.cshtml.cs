...
namespace Conference.Pages
{
    public class AudienceModel : PageModel
    {
        ...
        public AudienceModel(ConferenceContext context, UserManager<ApplicationUser> userManager,
        ...
        public IActionResult OnGet(int EventId)
        {
            ...
            if (EventObj != null)
            {
                ...
                EventActivity_SingleList = _context.EventActivity_Singles.Where(e => e.EventActivityType == 2&&e.EventId== EventId).ToList();
                return Page();
            }
            else
            {
        ...
        public IActionResult OnPost(List<int> Options)
        {
            if (Options != null)
            {
                ...
                return RedirectToPage("/Register", new { Options = str , EventId= EvId, EventSubscriptionType=2 });
